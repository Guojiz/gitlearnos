...
- Reading notes are scattered across PDFs, chats, and highlights.
- It is easy to remember a paper title but forget the actual argument.
- Comparisons between papers are often rebuilt from scratch.
- Follow-up questions disappear after one discussion.

## How the repository handles one paper
