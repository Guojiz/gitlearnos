...
description: 捕获、整理、去重、连接并协调来自教师、课堂、辅导、拍摄页面、截图、纸质笔记、书籍、练习平台、考试、同伴或 AI 的学习输入。学习者分享有价值的材料、反馈、结果、订正或已解决的问题时，即使没有要求保存或提到 GitLearnOS，也应自动考虑使用本 Skill。
---

# GitLearnOS 整理

遵循根目录英文 [`GITLEARNOS.md`](../../../GITLEARNOS.md) 中的证据、所有权、写入权限与 Git 规则；它是唯一正式协议。本 Skill 只定义整理工作流。

[English source](../../../skills/gitlearnos-organize/SKILL.md)
